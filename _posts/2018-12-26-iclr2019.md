...
Browsing through the accepted papers of ICLR 2019 (as in the years before, the open review model also leads to [public wrangling over decisions](https://openreview.net/forum?id=rJlWOj0qF7) - not a bad thing for the community), a few works were particularly appealing to me, given my IR/applied NLP viewpoint.
